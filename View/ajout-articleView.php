        ...
        <div class="container-fluid ">
            <div class="row">
                <div class="col-sm-12 col-lg-6 Article">
                    ...
                    <?php if ($addArticleOk == 0) { //condition si la variable $addArticleOk == 0, le profil n'est pas complet donc afficher une alerte?>

                        <div class="alert alert-dark" role="alert">
                            Veuillez compléter votre profil pour ajouter un article.
                        </div>

                    <?php } else {  //sinon afficher le formulaire lié à l'ajout d'un article
                        ?>
                        ...
                        <?php } else { //sinon afficher message de confirmation, showForm renvoie donc false  ?>
                            ...
                            <div id="AddArticleButton"><button onclick="(window.location = 'ajout-articleView.php?id=<?= $_SESSION['idUser']; ?>')" class="btn btn-raised btn-primary">Ajouter un article</button></div>
