...
//    affiche a partir de la catégorie, les sous catégories et les produits associés
//     SELECT `velo_maincat`. `maincat_id`, 
//        `maincat_name`, 
...
//    $maincatId = $_GET['maincat_id'];
//    $subcatId = $_GET['subcat_id'];
//    
//    //j'applique la méthode navbar()
//    $ArrayProductNavbar = $navbarElementsObj->navbar($maincatId, $subcatId);
//} else {
